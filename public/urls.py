...
urlpatterns = [
     ...
     url(r'^searchcontacts/$', pubviews.searchcontacts),
     ...
     url(r'^send_contact_request/(?P<touserid>[0-9,a-z,A-Z]+)$',
         pubviews.send_contact_request),

     url(r'^searchteams/$', pubviews.searchteams),
     url(r'^team/(?P<hostedteamid>[0-9,a-z,A-Z,-]+)$', pubviews.teamboard),
     url(r'^uploadzip/$', pubviews.uploadzip),
