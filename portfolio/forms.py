...
class portfolioForm(forms.ModelForm):
    ...
    portfolio_url = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'required': 'required','placeholder':'Portfolio Url*'}))
    portfolio_host = forms.CharField(widget=forms.TextInput(attrs={'type':'hidden'}))
